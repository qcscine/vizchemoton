...
The research group of Markus Reiher at ETH Zürich has developed the software enviroment `SCINE <https://github.com/qcscine>`_  which pursues the performance of quantum chemical calculations with special focus
