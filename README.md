...
* **Standalone HTML** for visualizing and interacting with reaction networks (see [example](https://enricpp.gitlab.io/crn_t_wsmiles.html))
* Interoperable reaction data in **CSV (reactions)** and **JSON (compounds)** formats for downstream machine learning applications
* Compound **search via SMILES and InChIKeys** within the reaction network and public databases (PubChem, ChEMBL, and ChEBI)
* Interfaces to reaction data with **cheminformatics applications**
